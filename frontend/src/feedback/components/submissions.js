...
function Submissions() {
    ...
    const [singleEntry, setSingleEntry] = useState({'name': '', 'email': '','phone': '', 'checkbox_values':[], 'custom_feedback': ''})
            ...
            <Container>
                <Card>
                    ...
                    <Card.Body>
                        ...
                        <Row>
                            <Col>Custom Feedback</Col>
                            <Col>{singleEntry['custom_feedback']}</Col>
                        </Row>
